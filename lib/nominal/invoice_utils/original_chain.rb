class Invoice::OriginalChain
  
  # variable estática que carga los archivo xslt del CFDI y TFD
  @@invoice_original_chain_xslt = Nokogiri::XSLT(File.open(File.join(Rails.root, 'private', 'sat','cadenaoriginal_3_2.xslt')))
  @@tfd_original_chain_xslt = Nokogiri::XSLT(File.read(File.join(Rails.root, 'private', 'sat','cadenaoriginal_TFD_1_0.xslt')))
